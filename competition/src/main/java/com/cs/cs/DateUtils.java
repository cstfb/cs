...
public class DateUtils {
    ...
    public static Integer getDiffHours(Date after, Date before) {
        ...
        Integer hoursInt =  Integer.parseInt(String.valueOf(hours));
        return hoursInt;
    }
    ...
    public static void main(String[] args){
        //        System.out.debuginfo(addDate(new Date(), -2, "yyyy-MM-dd"));
...
//      System.out.debuginfo(needUpdatedTableName.get(i));
//    }
//    for(int i=0;i<needUpdatedMonth.size();i++){
//      System.out.debuginfo(needUpdatedMonth.get(i));
//    }
